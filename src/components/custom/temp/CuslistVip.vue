<template>
    <div class="cus_list Page">
        ...
        <div v-for="(item,index) in cusList" :key="index" class="cus_row flex_align">
            <router-link tag="div" class="name flex_1 lyui_tap_active" :to="'/custom/detail/'+item.cid">
                {{item.name}}<br>
            ...
            <router-link tag="div" class="more lyui_tap_active" :to="'/order/add/'+item.cid">
                <div class="img"></div>
                <p>录单</p>
            </router-link>
        </div>
